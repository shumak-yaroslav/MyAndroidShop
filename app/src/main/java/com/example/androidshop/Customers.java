        ...
        linear1.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer1.class);
    ...
    public void imageClick2 () {
        linear2.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer2.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick3 () {
        linear3.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer3.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick4 () {
        linear4.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer4.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick5 () {
        linear5.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer5.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick6 () {
        linear6.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer6.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick7 () {
        linear7.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer7.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick8 () {
        linear8.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer8.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick9 () {
        linear9.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer9.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick10 () {
        linear10.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer10.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick11 () {
        linear11.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Customers.this, Customer11.class);
                        startActivity(intent);
                    }
                }
        );
