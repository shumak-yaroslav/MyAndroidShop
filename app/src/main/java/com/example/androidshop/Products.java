        ...
        linear1.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product1.class);
    ...
    public void imageClick2 () {
        linear2.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product2.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick3 () {
        linear3.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product3.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick4 () {
        linear4.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product4.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick5 () {
        linear5.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product5.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick6 () {
        linear6.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product6.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick7 () {
        linear7.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product7.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick8 () {
        linear8.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product8.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick9 () {
        linear9.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product9.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick10 () {
        linear10.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product10.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void imageClick11 () {
        linear11.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Products.this, Product11.class);
                        startActivity(intent);
                    }
                }
        );
